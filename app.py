...
st.caption("Desenvolvido em Python pela Profa. Adriana Regina Tozzi para a Disciplina")
st.caption("de Pontes do Curso de Engenharia Civil do Centro Universitário Uninter.")
